from ingrain_inference.inference.preprocessors.image_preprocessor import ImagePreprocessor, ResizeImage, ConvertToRGB, image_transform_from_dict
...
def test_image_preprocessor():
    ...
    transformed_image = Image.fromarray((transformed_image_arr * 255).astype('uint8').transpose(1, 2, 0))
