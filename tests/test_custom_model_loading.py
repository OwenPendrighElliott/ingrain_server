# // TODO: Rework custom models and fix these tests
# import pytest
# import requests
...
#     response = requests.post(f"{INFERENCE_SERVER_URL}/embed_text", json=body)
#     assert response.status_code == 200
...
#     response = requests.post(f"{INFERENCE_SERVER_URL}/embed_image", json=body)
