...
# from ingrain_inference_server.ingrain_inference.inference.triton_open_clip.clip_inference import (
#     TritonCLIPInferenceClient,
# )
# from ingrain_inference_server.ingrain_inference.inference.triton_sentence_transformers.sentence_transformer_inference import (
#     TritonSentenceTransformersInferenceClient,
# )
# from ingrain_inference_server.ingrain_inference.inference.model_cache import LRUModelCache
...
#     cache.get(("non_existing_model", None))
#     stats = cache.get_stats()
#     assert stats["hits"] == 2
